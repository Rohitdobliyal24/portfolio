    ...
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-end m-3 card-img_hover">
          ...
          <div
            onClick={() => window.open(live_address, "_blank")}
            className="bg-gradient-to-r from-green-500 to-green-700 w-10 h-10 rounded-full ml-1 flex justify-center items-center cursor-pointer"
          >
            <img
              src={live}
              alt="source code"
